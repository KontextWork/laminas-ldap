...
/**
 * Paginated ldap iterator adapted to work with the KontextWork version of ldap_php library. The original implementation
 * can be found at https://github.com/silverstripe/silverstripe-ldap/blob/master/src/Iterators/LDAPIterator.php
 *
 * Class documentation as per original found below
 *
 * ----------------------------
 *
 * Class LDAPIterator
 ...
 */
final class LdapPaginatedIterator implements Iterator
{
  private $ldap;
  private $filter;
  private $baseDn;
